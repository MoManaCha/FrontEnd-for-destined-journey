...
export const InitialItems: ItemData = {
  ...
  Money: [
    // 白 (Common, 1-10)
    { name: '一点点钱', type: '货币', rarity: 'common', description: '初始自带10银币、10铜币。' },
    // 绿 (Uncommon, 11-20)
    { name: '一些钱', type: '货币', rarity: 'uncommon', description: '初始自带30银币、30铜币。' },
    // 蓝 (Rare, 21-35)
    { name: '不算少的钱', type: '货币', rarity: 'rare', description: '初始自带60银币、60铜币。' },
    // 紫 (Epic, 36-50)
    { name: '很多钱', type: '货币', rarity: 'epic', description: '初始自带30金币、50银币、50铜币。' },
    // 金 (Legendary, 51-100)
    {
      name: '很多很多钱',
      type: '货币',
